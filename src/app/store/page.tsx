                ...
                <div className="flex items-center gap-1 text-sm">
                  <div className="relative">
                    ...
                    <label
                      ...
                      className="absolute left-0 ml-2 -translate-y-3 bg-opacity-0 px-1 text-xs duration-100 ease-linear peer-placeholder-shown:translate-y-0 peer-placeholder-shown:text-base peer-placeholder-shown:text-lightgray peer-focus:ml-0 peer-focus:-translate-y-2 peer-focus:px-1 peer-focus:text-xs"
                    >
                      From
                    </label>
                  </div>
